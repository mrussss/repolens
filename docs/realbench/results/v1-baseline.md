...
- RepoLens commit: `40c1f4ada9949ec43abdd8ed445dcc56a5fbfbb7`
- Run ID: `20260903T102350Z-6aee2c8b`
...
- E2E: `NOT_RUN_PROVIDER_NOT_CONFIGURED`
...
本次没有配置稳定的真实 LLM provider，因此没有生成真实 Agent diagnosis、Citation validity 或 Root Cause Correct/Partial/Incorrect 分数；FakeProvider 不作为公开 E2E 成绩。
